...
func (c *shopInterfaceClient) RemoveCartItems(ctx context.Context, in *RemoveCartItemsRequest, opts ...grpc.CallOption) (*RemoveCartItemsReply, error) {
	out := new(RemoveCartItemsReply)
	err := c.cc.Invoke(ctx, "/api.shop.interface.v1.ShopInterface/RemoveCartItems", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *shopInterfaceClient) DeleteAddress(ctx context.Context, in *DeleteAddressRequest, opts ...grpc.CallOption) (*DeleteAddressReply, error) {
	out := new(DeleteAddressReply)
	err := c.cc.Invoke(ctx, "/api.shop.interface.v1.ShopInterface/DeleteAddress", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedShopInterfaceServer) DeleteAddress(context.Context, *DeleteAddressRequest) (*DeleteAddressReply, error) {
...
func _ShopInterface_RemoveCartItems_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RemoveCartItemsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ShopInterfaceServer).RemoveCartItems(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.shop.interface.v1.ShopInterface/RemoveCartItems",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ShopInterfaceServer).RemoveCartItems(ctx, req.(*RemoveCartItemsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _ShopInterface_DeleteAddress_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeleteAddressRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ShopInterfaceServer).DeleteAddress(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.shop.interface.v1.ShopInterface/DeleteAddress",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ShopInterfaceServer).DeleteAddress(ctx, req.(*DeleteAddressRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ShopInterface_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _ShopInterface_DeleteAddress_Handler,
		},
	},
