...
func NewShopInterface(uc *biz.UserUsecase, catc *biz.CategoryUsecase, gc *biz.GoodsUsecase, cc *biz.CartUsecase, ac *biz.AddressUsecase, logger log.Logger) *ShopInterface {
