...
type Data struct {
	...
	Weixin   *Data_Weixin   `protobuf:"bytes,3,opt,name=weixin,proto3" json:"weixin,omitempty"`
}
...
func (x *Data) GetWeixin() *Data_Weixin {
	if x != nil {
		return x.Weixin
	}
	return nil
...
func (x *Data_Weixin) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Data_Weixin) ProtoMessage() {}

func (x *Data_Weixin) ProtoReflect() protoreflect.Message {
	mi := &file_conf_conf_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Data_Weixin.ProtoReflect.Descriptor instead.
func (*Data_Weixin) Descriptor() ([]byte, []int) {
	return file_conf_conf_proto_rawDescGZIP(), []int{2, 2}
}

func (x *Data_Weixin) GetAddr() string {
	if x != nil {
		return x.Addr
	}
	return ""
...
func (x *Data_Weixin) GetAppid() string {
	if x != nil {
		return x.Appid
	}
	return ""
...
func (x *Data_Weixin) GetSecret() string {
	if x != nil {
		return x.Secret
	}
	return ""
...
func (x *Data_Weixin) GetGrantType() string {
	if x != nil {
		return x.GrantType
	}
	return ""
...
var file_conf_conf_proto_rawDesc = []byte{
	...
	0x74, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x22, 0xbc, 0x05, 0x0a, 0x04, 0x44, 0x61, 0x74, 0x61,
	...
	,
	...
	0x06, 0x20, 0x01, 0x28, 0x05, 0x52, 0x04, 0x70, 0x6f, 0x72, 0x74, 0x1a, 0x9d, 0x02, 0x0a, 0x05,
	...
	0x72, 0x69, 0x74, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x1a, 0x69, 0x0a, 0x06, 0x57,
	0x65, 0x69, 0x78, 0x69, 0x6e, 0x12, 0x12, 0x0a, 0x04, 0x61, 0x64, 0x64, 0x72, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x04, 0x61, 0x64, 0x64, 0x72, 0x12, 0x14, 0x0a, 0x05, 0x61, 0x70, 0x70,
	...
	0x06, 0x73, 0x65, 0x63, 0x72, 0x65, 0x74, 0x12, 0x1d, 0x0a, 0x0a, 0x67, 0x72, 0x61, 0x6e, 0x74,
	0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x67, 0x72, 0x61,
	0x6e, 0x74, 0x54, 0x79, 0x70, 0x65, 0x42, 0x19, 0x5a, 0x17, 0x6d, 0x61, 0x6c, 0x6c, 0x2f, 0x69,
...
var file_conf_conf_proto_goTypes = []interface{}{
	...
	(*Data_Weixin)(nil),         // 7: kratos.api.Data.Weixin
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	7,  // 6: kratos.api.Data.weixin:type_name -> kratos.api.Data.Weixin
